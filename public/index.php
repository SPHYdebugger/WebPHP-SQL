...
// LISTO PARA SEGUNDA ENTREGA 07/05/24
        ...
        <div class="container marketing">
            ...
            <div class="row justify-content-center" style="text-align: center; margin-top: 30px; margin-bottom: 30px;">
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-secondary" href="../app/Controllers/client_controller.php?action=list_all" role="button">ENTRAR &raquo;</a></p>
                ...
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-secondary" href="../app/Controllers/product_controller.php?action=list_all" role="button">ENTRAR &raquo;</a></p>
                </div >
            ...
            <div id="eventos" class="row featurette" style="margin-top: 30px; margin-bottom: 30px;">
                ...
                <div class="col-md-5">
                    <img class="featurette-image img-fluid mx-auto" src="../resources/images/evento%20maquillaje.jpg" alt="Generic placeholder image">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <img class="featurette-image img-fluid mx-auto" src="../resources/images/evento%20hombres.jpg" alt="Generic placeholder image">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img class="featurette-image img-fluid mx-auto" src="../resources/images/evento%20antiedad.jpg" alt="Generic placeholder image">
                </div>
            </div>
