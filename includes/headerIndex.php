        ...
        <div class="collapse navbar-collapse" style="background-color: #EAD0D1;" id="navbarCollapse">
            <ul class="navbar-nav mr-auto" >
                <li class="nav-item active">
                    <a class="nav-link" href="../public/index.php" style="color: black;">INICIO <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../public/index.php#eventos" style="color: black;">EVENTOS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../app/Controllers/shop_controller.php" style="color: black;">CONTACTO</a>
                </li>
            </ul>
            <?php
