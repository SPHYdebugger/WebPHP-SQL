...
<main role="main">
    <div class="container" style="margin-top: 150px">
        ...
        <div style="text-align-last: justify; background-color: #EAD0D1; margin-bottom: 10px">
            <a href="../../app/Controllers/product_controller.php?action=list_all" class="btn btn-secondary" style="margin: 20px;">TODAS</a>
            <a href="../../app/Controllers/product_controller.php?action=list_all&category=cara"" class="btn btn-secondary" style="margin: 20px;">CARA</a>
            <a href="../../app/Controllers/product_controller.php?action=list_all&category=cuerpo" class="btn btn-secondary" style="margin: 20px;">CUERPO</a>
            <a href="../../app/Controllers/product_controller.php?action=list_all&category=pelo" class="btn btn-secondary" style="margin: 20px;">PELO</a>
        </div>
        <div class="row">
            <?php foreach ($products as $product) : ?>
                <div class="col-md-4 mb-4">
                    <div class="card" >
                        <img src="../../app/Controllers/product_controller.php?action=get_image&id=<?php echo $product->getId(); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            if (isset($_SESSION['usuario_logado']) && $_SESSION['usuario_logado'] == 'Santiago') { ?>
                                <td>
                                    <form method="post" action="../../app/Controllers/product_controller.php?action=edit_one">
                            ...
                            if (isset($_SESSION['usuario_logado']) && $_SESSION['usuario_logado'] == 'Santiago') { ?>
                                <td>
                                    <form method="post" action="../../app/Controllers/product_controller.php?action=delete_one">
