        ...
        <div class="collapse navbar-collapse" style="background-color: #EAD0D1;" id="navbarCollapse">
            <ul class="navbar-nav mr-auto" >
                <li class="nav-item active">
                    <a class="nav-link" href="../home.php" style="color: black;">INICIO <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../home.php#eventos" style="color: black;">EVENTOS</a>
                </li>
                <li class="nav-item">
            ...
            if(isset($_SESSION['usuario_logado'])) {
                ...
                <p style="margin-left: 10px;"><a class="btn btn-lg btn-primary" href="../../../resources/register/signUp.php" role="button">Sign up</a></p>
                </form>
                <?php
            }
            ?>
