        ...
        <div class="container marketing">
            ...
            <div class="row justify-content-center" style="text-align: center; margin-top: 30px; margin-bottom: 30px;">
                ...
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-secondary" href="../public/index.php/product/list_all" role="button">ENTRAR &raquo;</a></p>
                ...
                if(isset($_SESSION['usuario_logado'])) { ?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <p><a class="btn btn-secondary" href="../Controllers/buy_controller.php?action=list_all" role="button">ENTRAR &raquo;</a></p>
